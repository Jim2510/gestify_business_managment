...
const Cards = () => {
  return (
    <div className='w-full py-[10rem] px-4 bg-white' id='secfour'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          ...
          <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
              ...
              <h2 className='text-2xl font-bold text-center py-8'>Project management</h2>
              <p className='text-center text-4xl font-bold'>Integration</p>
              <div className='text-center font-medium'>
                  <p className='py-2 border-b mx-8 mt-8'>Monitor the progress of projects</p>
          ...
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              ...
              <h2 className='text-2xl font-bold text-center py-8'>Customer management</h2>
              <p className='text-center text-4xl font-bold'>Scalability</p>
              <div className='text-center font-medium'>
                  <p className='py-2 border-b mx-8 mt-8'>Track customer information</p>
