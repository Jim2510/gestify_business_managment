          ...
          <div className="flex relative w-full z-10 pt-8">
            <animated.div style={springs} className="w-[100%] mt-20 ">
              <p className="text-white mt-[-30px] font-extrabold pl-16 text-[60px] drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
                WELCOME <span className="text-[#997fde] underline ml-4">{name.toLocaleUpperCase()}</span>
              </p>
            ...
            <div className=" drop-shadow-2xl w-[50%] relative z-0 sm:flex hidden h-[250px] justify-center items-center">
              <animated.div
                style={springs2}
                className="drop-shadow-2xl w-full h-[80px] overflow-hidden justify-center items-center absolute right-[240px]"
              >
                <img
        ...
        <div className="w-[95%] h-full flex justify-center items-center gap-6">
          <div className="w-[40%] gap-4 h-[400px] p-4 mt-10 grid grid-rows-2 grid-cols-1 justify-center items-center ">
            <div className="grid grid-cols-3 h-full gap-4 font-semibold justify-between items-center text-[20px] text-center">
              ...
              <div className="shadow-2xl col-span-1 py-6 h-full flex justify-around items-center flex-col bg-white">
                <Link to='/events' className="flex flex-col justify-around w-full h-full items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="50"
                  height="50"
              ...
              <Link to='/backoffice' className="flex flex-col justify-around w-full h-full items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="50"
                  height="50"
            ...
            <div className="grid grid-cols-2 h-full gap-4 font-semibold justify-between items-center text-[20px] text-center ">
              ...
              <div className="shadow-2xl col-span-1 py-6 h-full flex justify-around items-center flex-col bg-white">
              <Link to='/storage' className="flex flex-col justify-around w-full h-full items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="50"
                  height="50"
                ...
                <Link to='/orderhistory' className="flex flex-col justify-around w-full h-full items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="50"
                    height="50"
          ...
          <div className="w-[900px] h-[400px] mt-10 flex flex-col justify-center items-center bg-transparent p-4">
            <div className="grid grid-rows-3 w-full h-full grid-cols-1 gap-4 font-semibold justify-center items-center text-[20px] text-center ">
              <div className=" bg-white w-full shadow-2xl h-full px-10 flex flex-col justify-around py-4 ">MONTH 
              <ProgressBar completed={30} bgColor="#02f9ae"/>
              </div>
              <div className=" bg-white w-full shadow-2xl h-full px-10 flex flex-col justify-around py-4">WEEK
              <ProgressBar completed={60} bgColor="#1cdafe"/>
              </div>
              <div className=" bg-white w-full shadow-2xl h-full px-10 flex flex-col justify-around py-4">DAY
