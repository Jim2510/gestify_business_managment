    ...
    <>
      <div className=" h-full flex justify-center items-center pt-10  z-20 flex-col dark:bg-gradient-to-b dark:from-slate-900 dark:to-slate-500 bg-transparent overflow-hidden">
          ...
          <div className="flex relative w-full z-10 pt-8">
            <animated.div style={springs} className="w-[100%] mt-20">
              <p className="text-white mt-[-30px] font-extrabold pl-16 md:text-[40px] sm:text-[30px] text-[34px] drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
                Welcome <b className="text-[#ce525a] underline ">Tega</b>
                {name}
              </p>
              <p className="p-5 mt-4 text-white font-bold pl-16 md:text-[30px] sm:text-[20px] text-[22px] drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
        ...
        <div className="w-[95%] h-full flex justify-center items-center gap-6">
          ...
          <div className="w-[900px] h-[400px] mt-10 flex flex-col justify-center items-center bg-opacity-5 bg-black p-4">
            <div className="grid grid-rows-3 w-full h-full grid-cols-1 gap-4 font-semibold justify-center items-center text-[20px] text-center">
              ...
              <ProgressBar completed={80} bgColor="#7ceaff"/>
              </div>
            </div>
          </div>
        </div>
