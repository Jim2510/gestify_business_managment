  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center mt-[100px]">
        ...
        <div className="flex items-center justify-center flex-col gap-4 w-[90%] relative ">
          <div className="grid grid-cols-4 px-4 gap-4 w-full">
            <FLineChart
              collection={"COLLECTION 1"}
              earns={2045}
              dataT={data.collection1}
            />
            <FLineChart
              collection={"COLLECTION 2"}
              earns={1355}
              dataT={data.collection2}
            />
            <FLineChart
              collection={"COLLECTION 3"}
              earns={4045}
              dataT={data.collection3}
            />
            <FLineChart
              collection={"COLLECTION 4"}
              earns={1045}
              dataT={data.collection4}
            />
          </div>
          <div className="grid grid-cols-4 px-4 gap-4 w-full">
