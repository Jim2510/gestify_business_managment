        ...
        <div className="flex flex-col w-[100vw] h-[100vh] text-center justify-center items-center mt-[30px] bg-gradient-to-b from-[#1cdafe] to-[#02f9ae]" onClick={() => setToggleSearchBar(false)}>
            ...
            <div className="flex flex-col w-[85%] h-[75%] shadow-lg rounded-md overflow-auto 2xl:w-[80%] bg-[#FAFAFC] justify-center items-center">
                <div className="bg-white w-[17%] h-[35px] rounded-2xl shadow-lg mb-[20px] mt-[15px] ml-[15px] flex items-center justify-center relative ">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="" class="fill-[#1E293B] " viewBox="0 0 16 16">
                ...
                <div className="flex self-end m-[15px]">
                    <button onClick={prePage}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="" class="fill-[#1E293B] mr-[5px]" viewBox="0 0 16 16">
                        <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0m3.5 7.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5z" />
                    </svg></button>
                    <div>
                        <ul className="flex">
                            {numbers.map((n, i) => (
                                <li key={i} className={`mr-[5px] text-[17px] font-medium px-[15px] py-[2px] rounded-full text-[#1E293B] ${currentPage === n ? 'bg-[#02f9ae]' : ''}`}>
                                    <button onClick={() => changePage(n)}>{n}</button>
                                </li>
                            ))}
                        </ul>
                    </div>
                    <button onClick={nextPage}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="" class="fill-[#1E293B]" viewBox="0 0 16 16">
