    ...
    return (
        <div className="flex flex-col w-[100vw] h-[100vh] text-center justify-center items-center">
            ...
            <div className="flex flex-col w-[80%] shadow-lg border-t-[4px] border-t-[#1E293B] rounded-md overflow-auto">
                <input className="mb-[20px] mt-[15px] ml-[15px] w-[200px] border-[3px] border-[#1E293B]" onChange={(e) => setSearchInput(e.target.value)} type="text" placeholder="Search" />
                ...
                <div className="flex self-end m-[15px]">
                    ...
                    <div className="text-[#18D3EA] text-[25px]">
                        <ul className="flex">
                            {numbers.map((n, i) => (
                                <li key={i} className={`mr-[5px] font-medium px-[15px] py-[2px] rounded-full text-[#1E293B] ${currentPage === n ? 'bg-[#02f9ae]' : ''}`}>
