...
export function Storage() {
    ...
    return (
        <div className="flex flex-col w-[100vw] h-[100vh] text-center justify-center items-center mt-[30px] bg-gradient-to-b from-[#1cdafe] to-[#02f9ae]" onClick={() => setToggleSearchBar(false)}>
            <h1 className="font-bold text-[30px] ">Storage</h1>
            <div className="flex flex-col w-[90%] h-[75%] shadow-lg border-t-[4px] border-t-[#1E293B] rounded-md overflow-auto 2xl:w-[80%] bg-white">
                <div className="bg-white w-[17%] rounded-2xl shadow-lg mb-[20px] mt-[15px] ml-[15px] flex items-center justify-center relative border-[3px] border-[#1E293B]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="" class="fill-[#1E293B] " viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0" />
                    </svg>
                    <input style={inputStyle.input} className="w-[70%] border-none text-[15px] h-[20%] bg-tranparent" onChange={(e) => { setSearchInput(e.target.value) }} onInput={(e) => handleToggle(e)} type="text" placeholder="Search" />
                </div>
                ...
                <div className="flex self-end m-[15px]">
                    ...
                    <div>
                        <ul className="flex">
                            {numbers.map((n, i) => (
                                <li key={i} className={`mr-[5px] text-[20px] font-medium px-[15px] py-[2px] rounded-full text-[#1E293B] ${currentPage === n ? 'bg-[#02f9ae]' : ''}`}>
